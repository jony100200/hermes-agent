...
const hermesAPI = {
  ...
  getRuntimePathConfig: (): Promise<{
    hermesRepoPath: string;
    pythonPath: string;
    hermesScriptPath: string;
    workspacePath: string;
  }> => ipcRenderer.invoke("get-runtime-path-config"),

  setRuntimePathConfig: (config: {
    hermesRepoPath: string;
    pythonPath: string;
    hermesScriptPath: string;
    workspacePath: string;
  }): Promise<boolean> => ipcRenderer.invoke("set-runtime-path-config", config),

  pickDirectory: (defaultPath?: string): Promise<string | null> =>
    ipcRenderer.invoke("pick-directory", defaultPath),

  pickFile: (defaultPath?: string): Promise<string | null> =>
    ipcRenderer.invoke("pick-file", defaultPath),
